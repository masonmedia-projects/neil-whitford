...
<div class="container-fluid relative m-0 p-0" data-aos="fade">
  ...
  <div class="row relative bg-black text-light p-5">
    ...
    <div class="col-lg-12 d-flex flex-column justify-content-center align-items-start text-left min-500 p-4 mb-4 mb-0 rellax" data-rellax-speed="-1">
      ...
      <!-- 6 -->
      <iframe class="shadow rounded-lg mt-3" scrolling="no" id="hearthis_at_track_4827248" width="100%" height="150" src="https://app.hearthis.at/embed/4827248/transparent_black/?hcolor=14cfa0&color=&style=2&block_size=2&block_space=1&background=1&waveform=0&cover=1&autoplay=0&css=" frameborder="0" allowtransparency allow="autoplay"></iframe>
      <!-- 7 -->
      <iframe class="shadow rounded-lg mt-3" scrolling="no" id="hearthis_at_track_4827229" width="100%" height="150" src="https://app.hearthis.at/embed/4827229/transparent_black/?hcolor=14cfa0&color=&style=2&block_size=2&block_space=1&background=1&waveform=0&cover=1&autoplay=0&css=" frameborder="0" allowtransparency allow="autoplay"></iframe>
      <!-- 8 -->
      <iframe class="shadow rounded-lg my-3" scrolling="no" id="hearthis_at_track_4827254" width="100%" height="150" src="https://app.hearthis.at/embed/4827254/transparent_black/?hcolor=14cfa0&color=&style=2&block_size=2&block_space=1&background=1&waveform=0&cover=1&autoplay=0&css=" frameborder="0" allowtransparency allow="autoplay"></iframe>
